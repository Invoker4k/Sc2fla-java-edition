...
public final class FBTexture extends com.google.flatbuffers.Table {
  ...
  public boolean mutateFlags(int flags) { int o = __offset(4); if (o != 0) { bb.put(o + bb_pos, (byte) flags); return true; } else { return false; } }
  ...
  public boolean mutateWidth(int width) { int o = __offset(8); if (o != 0) { bb.putShort(o + bb_pos, (short) width); return true; } else { return false; } }
  public int height() { int o = __offset(10); return o != 0 ? bb.getShort(o + bb_pos) & 0xFFFF : 0; }
  public boolean mutateHeight(int height) { int o = __offset(10); if (o != 0) { bb.putShort(o + bb_pos, (short) height); return true; } else { return false; } }
  ...
  public boolean mutateData(int j, byte data) { int o = __offset(12); if (o != 0) { bb.put(__vector(o) + j * 1, data); return true; } else { return false; } }
