...
public class SymbolItem {
    ...
    public byte[] toXmlBytes() throws Exception {
        ...
        if (scaleGridLeft != null) root.setAttribute("scaleGridLeft", Utils.fmt(scaleGridLeft));
        if (scaleGridTop != null) root.setAttribute("scaleGridTop", Utils.fmt(scaleGridTop));
        if (scaleGridRight != null) root.setAttribute("scaleGridRight", Utils.fmt(scaleGridRight));
        if (scaleGridBottom != null) root.setAttribute("scaleGridBottom", Utils.fmt(scaleGridBottom));
