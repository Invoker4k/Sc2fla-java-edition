...
public class Color {
    ...
    public Element save(Document doc) {
        ...
        if (redMultiplier != null) el.setAttribute("redMultiplier", Utils.fmt(redMultiplier));
        if (redOffset != null) el.setAttribute("redOffset", String.valueOf(redOffset));
        if (greenMultiplier != null) el.setAttribute("greenMultiplier", Utils.fmt(greenMultiplier));
        if (greenOffset != null) el.setAttribute("greenOffset", String.valueOf(greenOffset));
        if (blueMultiplier != null) el.setAttribute("blueMultiplier", Utils.fmt(blueMultiplier));
        if (blueOffset != null) el.setAttribute("blueOffset", String.valueOf(blueOffset));
        if (alphaMultiplier != null) el.setAttribute("alphaMultiplier", Utils.fmt(alphaMultiplier));
